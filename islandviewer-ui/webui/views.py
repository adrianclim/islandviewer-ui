...
from webui.models import Analysis, GenomicIsland, GC, CustomGenome, UploadGenome, NameCache, Genes, GIAnalysisTask, Distance, Notification, SiteStatus, STATUS, STATUS_CHOICES, \
    MODULES
from webui.models import VIRULENCE_FACTOR_CATEGORIES
