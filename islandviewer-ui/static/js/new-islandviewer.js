...
Islandviewer.prototype.onclick = function(trackname, d, plotid, skip_half_range) {
    // If the plot is linear do this:
    if(plotid.indexOf('linear')>-1) {
...
//TODO: Possibly hardcoded here at gene_overlay_....
...
//TODO: Possibly hardcodede here at gene_overlay...
...
Islandviewer.prototype.reload = function(features) {
	...
	if('undefined' !== typeof features['d'] && ! features['d'] ) {
	    $('#gene_dialog').dialog( 'close' );islandviewer
	}
    }
